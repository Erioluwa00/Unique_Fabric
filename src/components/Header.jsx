...
const Header = () => {
  ...
  // Get user role using the method from AuthContext
  const userRole = getUserRole()
  
  // Check if user has admin, manager, or staff privileges (case insensitive)
  const hasAdminAccess = user && ['admin', 'manager', 'staff'].includes(userRole.toLowerCase())

  // Get display text for the button based on role
