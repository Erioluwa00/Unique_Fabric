...
const UserPreviousOrders = () => {
  ...
  const getTabCount = (tab) => {
    switch (tab) {
      ...
      case 'returned':
        return orders.filter(order => order.returnStatus === 'returned').length;
      default:
        return 0;
    }
  };
  ...
  const allOrdersContent = filteredOrders.length > 0 ? (
      ...
      {filteredOrders.map(order => (
        <div key={order._id} className="order-card">
          ...
          <div className="order-actions">
            <Link to={`/orders/${order._id}`} className="action-btn view-details">
              View Details
            </Link>
    ...
    <div className="empty-orders">
      ...
      <p>
        {activeTab === 'all' && 'When you place orders, they will appear here with all the details you need to track your purchases.'}
        {activeTab === 'delivered' && 'Your delivered orders will appear here once they are completed and marked as delivered.'}
        {activeTab === 'canceled' && 'Orders you cancel will appear here for your reference.'}
        {activeTab === 'returned' && 'Items you return will be listed here along with their return status.'}
      </p>
      {activeTab === 'all' && (
