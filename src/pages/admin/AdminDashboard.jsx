...
//   // Enhanced protection - redirect if not authorized
//   useEffect(() => {
//     if (user && !['admin', 'manager', 'staff'].includes(userRole)) {
//       navigate('/');
//       return;
//     }
...
//           <h3>Access Denied</h3>
//           <p>You need appropriate privileges to access this page.</p>
...
//         <div>
//           <h2>Dashboard Overview</h2>
//           <p>Welcome to your fabric store management system - <strong>{getWelcomeMessage()}</strong></p>
//           <div className="role-indicator">
//             Logged in as: <span className="role-badge" style={{ backgroundColor: getRoleColor() }}>
  ...
  try {
    ...
    try {
      ...
      if (ordersResponse.ok) {
        ...
        // User doesn't have permission to view orders, that's okay
